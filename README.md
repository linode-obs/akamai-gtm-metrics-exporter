...
```bash
git clone https://github.com/akamai/akamai-gtm-metrics-exporter.git
```

2. **Choose your build method:**
fter cloning, you can generate a local binary or a Docker image.
...
`/akamai/akamai-gtm-metrics-exporter-linux-amd64:<git-branch>` 

or 

`/akamai/akamai-gtm-metrics-exporter-linux-arm64:<git-branch>`
